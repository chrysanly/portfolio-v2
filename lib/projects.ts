...
import { PROJECT_TYPES, type Project, type ProjectType, projectFrontmatterSchema } from './schema';
 ...
 */
export function attribution(project: Pick<Project, 'confidential' | 'client' | 'sector'>): string {
